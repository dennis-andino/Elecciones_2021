...
<%
    ...
    result_presi = datos.AlcaldesPorMesa(mesa);
%>
...
<script>
    $(function () {
        var chartOptions = {
            ...
            title: {
                text: 'Estadisticas para candidatos a la alcaldia para la <%=request.getSession().getAttribute("descripcion_mesa").toString() %>'
            },
            xAxis: {
