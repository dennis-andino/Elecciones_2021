...
<%
    ...
    String pie=datos.ResultadosPorPresidentePieMesa(mesa).trim();
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Estadísticas por mesa</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Votos para presidente en <%=request.getSession().getAttribute("descripcion_mesa").toString() %></h5>
                        </div>
