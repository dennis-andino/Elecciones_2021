        ...
        <nav class="main-header navbar navbar-expand navbar-dark navbar-navy">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="home_magistrado.jsp?panel=resultados_mesa" class="nav-link">Inicio</a>
                </li>
            </ul>
            <!-- Right navbar links -->
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <a href="#" class="d-block">Magistrado</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                         <li class="nav-item">
                            <a href="home_magistrado.jsp?panel=resultados_resumen" class="nav-link">
